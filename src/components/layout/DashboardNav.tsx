...
const navItems: {
  ...
  {
    href: "/dashboard/viral-magnet",
    label: "Viral Magnet",
    isActive: (p) => p.startsWith("/dashboard/viral-magnet"),
    icon: (
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5}
  ...
  {
    href: "/dashboard/ab-titles",
    label: "A/B Titles",
    isActive: (p) => p.startsWith("/dashboard/ab-titles"),
    icon: (
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5}
    ...
    <nav style={{
      ...
      <div style={{ padding: "12px 12px", borderTop: `1px solid ${C.border}`, display: "flex", flexDirection: "column", gap: 2 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10, padding: "10px 12px", borderRadius: 8 }}>
          {/* Colors come from the global dark theme on ClerkProvider; only size the avatar here. */}
