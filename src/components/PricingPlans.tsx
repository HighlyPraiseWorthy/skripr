...
const PLANS = [
  {
    ...
    features: ["12 scripts/month", "6 saved scripts", "5 Niche Bends/month", "Title Generator (unlimited)"],
    highlight: false,
  },
  {
    name: "Pro",
    ...
    features: ["25 scripts/month", "15 saved scripts", "15 Niche Bends/month", "Title Generator (unlimited)"],
    highlight: true,
    badge: "Most Popular",
  },
  {
    ...
    features: ["150 scripts/month", "Unlimited saved scripts", "150 Niche Bends/month", "Title Generator (unlimited)", "5 team seats"],
    highlight: false,
  },
];
