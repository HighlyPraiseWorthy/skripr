...
const plans = [
  {
    ...
    features: [
      { text: "20 scripts / month", ok: true },
      { text: "Niche Bend Engine", ok: true },
      { text: "Viral Remixer", ok: true },
      { text: "Viral Magnet Titles", ok: true },
      { text: "Metadata & A/B Testing", ok: true },
  ...
  },
  {
    ...
    features: [
      { text: "50 scripts / month", ok: true },
      { text: "Niche Bend Engine", ok: true },
      { text: "Viral Remixer", ok: true },
      { text: "Viral Magnet Titles", ok: true },
      { text: "Metadata & A/B Testing", ok: true },
      { text: "Compliance Checker (20/mo)", ok: true },
  ...
  },
  {
    ...
    features: [
      { text: "200 scripts / month", ok: true },
      { text: "Niche Bend Engine", ok: true },
      { text: "Viral Remixer", ok: true },
      { text: "Viral Magnet Titles", ok: true },
      { text: "Metadata & A/B Testing", ok: true },
      { text: "Compliance Checker (100/mo)", ok: true },
      { text: "Priority generation", ok: true },
