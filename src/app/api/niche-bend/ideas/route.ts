...
export async function POST(req: Request) {
  ...
  try {
    ...
    const prompt = [
      ...
      `- Title: Use ONE of these 5 proven viral patterns from 3M-10M+ view videos. Each idea must use a DIFFERENT pattern:`,
      `  P1 BOLD DECLARATION (2-6 words, strong verb/adjective): "AI Slop Is Destroying The Internet" · "GERMANY IS OVER"`,
      `  P2 ACTUALLY (challenges what viewer believes): "Ozzy Is Actually the GREATEST" · "The Uncomfortable Truth About Ozempic"`,
      `  P3 DIRECT ADDRESS (You/Your/We): "You Need To Quit Weed." · "You Are More Stressed Than Ever"`,
      `  P4 SUPERLATIVE + STAKES: "The Dumbest Animal Alive" · "The Scariest Place in The Universe"`,
      `  P5 TWO UNEXPECTED THINGS COLLIDING: "How Nuclear Flies Protect You from Flesh-Eating Parasites"`,
      `  RULES: Under 65 chars · ONE strong emotional word · NEVER start with How to/The best/Complete guide/Top 10 · Sound human`,
