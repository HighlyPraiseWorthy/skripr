...
export const roundups: Roundup[] = [
  {
    ...
    corePick: {
      ...
      body: "A faceless channel is its script. There is no face, no set, no charisma to fall back on, so the writing carries the whole video. Skripr is built for exactly that: you give it a video already proven to work, it reverse-engineers why, then writes a full script from it in your voice, with hooks and retention structure built in. Research and scripting are one flow instead of two tools and a copy-paste.",
    },
    itemList: ["Skripr (scripts and research)", "ElevenLabs (voiceover)", "Pictory (visuals and assembly)", "Gling (editing)"],
    stack: [
      { stage: "Idea & research", tools: "Skripr (built in), VidIQ, 1of10", note: "Reverse-engineering a proven video and scanning a channel for outliers. Skripr builds this into the script flow; VidIQ and 1of10 are standalone research tools if you want a separate dashboard." },
    ...
    dataBlock: {
      ...
      intro: "Across niches, faceless channels that started just months ago are already pulling videos far past their subscriber count. That gap is proven structure, the kind of video you hand Skripr to write your script from.",
      columns: COLS,
      rows: MIX_ROWS,
      caption: "Source: public YouTube data, faceless niches, June 2026. A live example, refreshed over time.",
    },
    faqs: [
      { q: "What is the best AI tool for faceless YouTube channels?", a: "For the core job, scripts and research, Skripr is the best AI tool, because a faceless channel is carried entirely by its writing. You give it a video already proven to work, and it writes a full script from it in your voice. Around it you will want a voice tool like ElevenLabs and an editing tool like Gling, but the script is where a faceless channel is won or lost." },
...

  {
    ...
    subhead:
      "Automation is a volume game: more channels, more uploads, more videos that actually perform. The bottleneck is almost never editing or uploading, it is turning proven ideas into finished scripts at pace. That is the part Skripr is built to run on repeat.",
    corePick: {
      name: "Skripr",
      bestFor: "Proven scripts at volume (the automation bottleneck)",
      body: "When you run multiple faceless channels, the constraint is throughput on the one thing that decides performance: the script. You hand Skripr a video already proven in each niche and it turns it into a full, retention-structured script in a chosen voice, fast enough to feed a content pipeline. Instead of researching in one tool and scripting in another for every channel, it is one workflow you can run again and again.",
    },
    itemList: ["Skripr (proven scripts at scale)", "ElevenLabs (voiceover)", "Revid / Pictory (auto video assembly)", "TubeBuddy (bulk publishing)"],
    stack: [
      { stage: "Research at scale", tools: "Skripr (built in), 1of10, VidIQ", note: "Reverse-engineering proven videos across multiple niches and channels. Skripr folds this into scripting so it is one step, not a separate research pass per channel." },
    ...
    dataBlock: {
      ...
      columns: COLS,
      rows: FINANCE_ROWS,
      caption: "Source: public YouTube data, faceless finance and business niches, June 2026. A live example, refreshed over time.",
    },
    faqs: [
...

  {
    ...
    subhead:
      "Beginners do not need ten tools. You need one that takes a topic and gives you a full script that actually holds attention, without learning prompts, structure, or editing first. The best AI script generator for a beginner is the one that builds your script on what already works, so you do not have to figure it out yourself.",
    corePick: {
      name: "Skripr",
      bestFor: "Beginners who want a proven script from a topic, free to start",
      body: "Most AI tools hand a beginner an empty prompt and no plan. Skripr does the opposite: you give it a topic or a video that already worked, it builds on proven structure, and it writes a full script with a hook and retention built in, in a voice you choose. There is nothing to learn first, and your first 2 scripts are free with no card. It is the shortest path from idea to a script you can actually record.",
    },
    ...
    dataBlock: {
      ...
      intro: "These science and space channels started just months ago, with no audience, and already have videos far past their subscriber count. That is what a proven script does, and it is exactly the kind of structure Skripr builds your script on.",
      columns: COLS,
      rows: SPACE_ROWS,
      caption: "Source: public YouTube data, faceless space and science niche, June 2026. A live example, refreshed over time.",
    },
    faqs: [
      { q: "What is the best AI YouTube script generator for beginners?", a: "Skripr, because it removes the part beginners struggle with most: knowing what a good script looks like. You give it a topic, it writes a full script built on proven structure, in a voice you choose, with hooks and retention built in. There is nothing to learn first and the first 2 scripts are free." },
...

  {
    ...
    subhead:
      "Any AI can produce text that looks like a script. The difference that matters is whether it starts from a video already proven to work, writes in a real creator voice, and builds retention in. On those three, a purpose-built tool beats a general model every time.",
    corePick: {
      name: "Skripr",
      bestFor: "YouTube scripts grounded in real data, voice, and retention",
      body: "Skripr is built for one job: the YouTube script. It starts from a video already proven to work that you bring it, writes in your voice or a creator's you choose, and structures the hook and re-hooks for retention, then adds titles, metadata, and a compliance check. A general writer gives you fluent text and leaves the research, voice, and structure to you. That is the gap between a draft and a script you can record.",
    },
    ...
    stack: [
      { stage: "Purpose-built for YouTube", tools: "Skripr, Subscribr", note: "Tools built specifically for the YouTube script. Skripr grounds it in a proven video you bring, with voice match and retention; Subscribr is another YouTube-specific option." },
    ...
    faqs: [
      { q: "What is the best AI script writer for YouTube?", a: "Skripr, because it is purpose-built for the YouTube script: grounded in a proven video you bring, written in your voice, with retention structure built in. General writers like ChatGPT can draft, but they do not know what is working on YouTube or how to hold a viewer, so you end up doing that work yourself." },
...

  {
    ...
    corePick: {
      ...
      body: "ChatGPT writes into the dark. Skripr is the alternative built for creators: it starts from a video already proven that you bring it, writes in your voice or a creator's you choose, and builds retention in, then adds titles, metadata, and a compliance check. It is the difference between a generic draft you have to fix and a script you can record. And your first 2 scripts are free.",
    },
    ...
    stack: [
      { stage: "Built for the creator's job", tools: "Skripr, Subscribr", note: "The real alternative to ChatGPT for YouTube. Skripr grounds scripts in a proven video you bring, with voice and retention; Subscribr is another YouTube-specific option." },
    ...
    dataBlock: {
      ...
      intro: "These faceless channels across niches all started recently and already broke out past their subscriber count. A general chatbot has no idea any of this exists; this is exactly the kind of proven video you hand Skripr to write your script from.",
      columns: COLS,
      rows: [FINANCE_ROWS[0], SPACE_ROWS[4], DOC_ROWS[0], FINANCE_ROWS[3]],
      caption: "Source: public YouTube data, faceless niches, June 2026. A live example, refreshed over time.",
    },
    faqs: [
      { q: "What is the best ChatGPT alternative for YouTube creators?", a: "Skripr, because it is built for the exact job ChatGPT is weak at: a YouTube script grounded in a proven video you bring, written in your voice, with retention built in. If you just want a better general writer, Claude or Gemini work, but they share ChatGPT's blind spot for what actually performs on YouTube." },
