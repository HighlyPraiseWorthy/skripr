...
const FEATURES = [
  ...
  {
    emoji: "🧲",
    title: "Viral Magnet Titles",
    desc: "S, A, B, C-tier power words ranked by CTR lift. Drop in your title and script — get AI-generated viral title variations with grade breakdowns.",
  ...
  {
    emoji: "📊",
    title: "Metadata & A/B Testing",
    desc: "Generate click-optimized titles, descriptions, and tags. A/B test title variants to find the highest-CTR option before you publish.",
  ...
  },
  {
    ...
    desc: "Scan your script for demonetization risk across 6 YouTube policy dimensions before you hit record. Catch problems before they cost you revenue.",
