    ...
    content: (
      <div>
        <Section title="Why hooks make or break your channel">
          <p style={{ fontSize: 15, color: C.text, lineHeight: 1.7 }}>YouTube's algorithm measures drop-off at the 0-30 second mark. If viewers leave early, your video gets buried. If they stay, you get pushed to more feeds. The hook is the single most important moment in your entire script.</p>
        </Section>
  ...
  },
  {
    ...
    content: (
      <div>
        ...
        <Section title="Step 2, Lock your angle (optional but it sharpens the script)">
